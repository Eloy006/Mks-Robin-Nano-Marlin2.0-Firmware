...
void lv_draw_operation() {
  ...
  lv_label_set_text(label_levelstop, "Layer stop"/*leveling_menu.levelstop*/);
  lv_obj_align(label_levelstop, btn_levelstop, LV_ALIGN_CENTER, 0, 50);
  ...
  lv_label_set_text(label_op_filament, "Filament"/*leveling_menu.op_filament*/);
